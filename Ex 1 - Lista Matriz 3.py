matriza  = [[0, 1, 0], [1, 0, 0], [0, 0, 1]]
matrizb  = [[1, 1, 1], [0, 2, 3], [5, 5, 1]]
...
#print(determinant(matrizc, 1))

deta = determinant(matriza, 1)
detb = determinant(matrizb, 1)
detc = determinant(matrizc, 1)
